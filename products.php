        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div
                ...
                <div class="relative w-full md:w-[420px]">
                    <select
                        class="w-full bg-[#f3f5f6] text-secondary font-semibold px-8 py-5 pr-14 outline-none appearance-none border border-black/5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <article class="prod-card opacity-0 translate-y-10">
                    <div class="prod-inner border border-black/20 p-8 text-center bg-white">
                        ...
                        <!-- stars -->
                        <div class="mt-5 flex items-center justify-center gap-2 text-secondary text-lg">
                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                class="fa fa-star"></i><i class="fa fa-star"></i>
                        </div>

                        <div class="mt-10 flex justify-center">
                            <button class="prod-btn bg-[#f3f5f6] text-secondary font-semibold px-10 py-4">
                                Add to Cart
                            </button>
                        </div>
                    </div>
